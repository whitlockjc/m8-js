  ...
  describe('#dumpInstrument', () => {
    test('2.7.x', () => {
      Object.keys(m8Files['2.7.x'].instruments).forEach((fileName) => {
        ...
        expect(bufferFromDisk).toEqual(M8.dumpInstrument(instrFromDisk, diskFileReader))

        let bytesFileReader = new M8FileReader(Buffer.from(M8.dumpInstrument(instrFromDisk, diskFileReader)))
