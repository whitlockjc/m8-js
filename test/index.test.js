  ...
  describe('#dumpInstrument', () => {
    test('2.7.x', () => {
      Object.keys(m8Files['2.7.x'].instruments).forEach((fileName) => {
        ...
        expect(bufferFromDisk).toEqual(M8.dumpInstrument(instrFromDisk, diskFileReader.m8Version))

        let bytesFileReader = new M8FileReader(Buffer.from(M8.dumpInstrument(instrFromDisk, diskFileReader.m8Version)))
        let alteredInstr = M8.loadInstrument(bytesFileReader, bytesFileReader.m8Version)
