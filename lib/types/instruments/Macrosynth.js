...
const MacrosynthParameters = require('../internal/MacrosynthParameters')
 ...
 */
class Macrosynth extends BaseInstrument {
  /**
  ...
  constructor (m8ReaderOrVersion) {
    ...
    this.instrParams = new MacrosynthParameters()
  }
  ...
  static fromObject (object) {
    return instrFromObject(Macrosynth, MacrosynthParameters, object)
  }
}

module.exports = Macrosynth
