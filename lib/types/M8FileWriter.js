...
const { bytesFromFloatLE, toM8HexStr } = require('../helpers')
...
class M8FileWriter {
   ...
   *
   * @param {Float} val - The float value to write
   */
  writeFloat32 (val) {
    this.bytes.push(...bytesFromFloatLE(val))
  }
   ...
   */
  writeStr (theString, padTo, value) {
