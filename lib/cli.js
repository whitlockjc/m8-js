...
function loadTheme (theme) {
  m8Text.default = clc.xterm(x256(...theme.textDefault.asBytes()))
  m8Text.empty = clc.xterm(x256(...theme.textEmpty.asBytes()))
  m8Text.info = clc.xterm(x256(...theme.textInfo.asBytes()))
  m8Text.title = clc.xterm(x256(...theme.textTitle.asBytes()))
  m8Text.value = clc.xterm(x256(...theme.textValue.asBytes()))
}
...
${m8Text.default('BACKGROUND')}   ${m8Text.value(toM8HexStr(theme.background.r))} ${m8Text.value(toM8HexStr(theme.background.g))} ${m8Text.value(toM8HexStr(theme.background.b))} ${clc.xterm(x256(...theme.background.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:EMPTY')}   ${m8Text.value(toM8HexStr(theme.textEmpty.r))} ${m8Text.value(toM8HexStr(theme.textEmpty.g))} ${m8Text.value(toM8HexStr(theme.textEmpty.b))} ${clc.xterm(x256(...theme.textEmpty.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:INFO')}    ${m8Text.value(toM8HexStr(theme.textInfo.r))} ${m8Text.value(toM8HexStr(theme.textInfo.g))} ${m8Text.value(toM8HexStr(theme.textInfo.b))} ${clc.xterm(x256(...theme.textInfo.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:DEFAULT')} ${m8Text.value(toM8HexStr(theme.textDefault.r))} ${m8Text.value(toM8HexStr(theme.textDefault.g))} ${m8Text.value(toM8HexStr(theme.textDefault.b))} ${clc.xterm(x256(...theme.textDefault.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:VALUE')}   ${m8Text.value(toM8HexStr(theme.textValue.r))} ${m8Text.value(toM8HexStr(theme.textValue.g))} ${m8Text.value(toM8HexStr(theme.textValue.b))} ${clc.xterm(x256(...theme.textValue.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:TITLES')}  ${m8Text.value(toM8HexStr(theme.textTitle.r))} ${m8Text.value(toM8HexStr(theme.textTitle.g))} ${m8Text.value(toM8HexStr(theme.textTitle.b))} ${clc.xterm(x256(...theme.textTitle.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('PLAY MARKERS')} ${m8Text.value(toM8HexStr(theme.playMarker.r))} ${m8Text.value(toM8HexStr(theme.playMarker.g))} ${m8Text.value(toM8HexStr(theme.playMarker.b))} ${clc.xterm(x256(...theme.playMarker.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('CURSOR')}       ${m8Text.value(toM8HexStr(theme.cursor.r))} ${m8Text.value(toM8HexStr(theme.cursor.g))} ${m8Text.value(toM8HexStr(theme.cursor.b))} ${clc.xterm(x256(...theme.cursor.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('SELECTION')}    ${m8Text.value(toM8HexStr(theme.selection.r))} ${m8Text.value(toM8HexStr(theme.selection.g))} ${m8Text.value(toM8HexStr(theme.selection.b))} ${clc.xterm(x256(...theme.selection.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('SCOPE/SLIDER')} ${m8Text.value(toM8HexStr(theme.scopeSlider.r))} ${m8Text.value(toM8HexStr(theme.scopeSlider.g))} ${m8Text.value(toM8HexStr(theme.scopeSlider.b))} ${clc.xterm(x256(...theme.scopeSlider.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('METER LOW')}    ${m8Text.value(toM8HexStr(theme.meterLow.r))} ${m8Text.value(toM8HexStr(theme.meterLow.g))} ${m8Text.value(toM8HexStr(theme.meterLow.b))} ${clc.xterm(x256(...theme.meterLow.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('METER MID')}    ${m8Text.value(toM8HexStr(theme.meterMid.r))} ${m8Text.value(toM8HexStr(theme.meterMid.g))} ${m8Text.value(toM8HexStr(theme.meterMid.b))} ${clc.xterm(x256(...theme.meterMid.asBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('METER PEAK')}   ${m8Text.value(toM8HexStr(theme.meterPeak.r))} ${m8Text.value(toM8HexStr(theme.meterPeak.g))} ${m8Text.value(toM8HexStr(theme.meterPeak.b))} ${clc.xterm(x256(...theme.meterPeak.asBytes()))('\u25A0\u25A0\u25A0')}
`)
    })
