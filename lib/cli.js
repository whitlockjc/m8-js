...
const { FMSynth, Macrosynth, MIDIOut, Sampler, Wavsynth } = require('./types/Instrument')
const { EffectsSettings, MixerSettings } = require('./types/Song')

const InstrumentMIDIMappings = {
  0x00: Wavsynth.getMIDIDestLabels(),
  0x01: Macrosynth.getMIDIDestLabels(),
  0x02: Sampler.getMIDIDestLabels(),
  0x03: MIDIOut.getMIDIDestLabels(),
  0x04: FMSynth.getMIDIDestLabels()
}

const m8Text = {}

function getM8FileReaderAndVerify (filePath, type) {
  const fileReader = new M8FileReader(Uint8Array.from(readFileSync(filePath)))
...
function loadTheme (theme) {
  m8Text.default = clc.xterm(x256(...theme.textDefault.getBytes()))
  m8Text.empty = clc.xterm(x256(...theme.textEmpty.getBytes()))
  m8Text.info = clc.xterm(x256(...theme.textInfo.getBytes()))
  m8Text.title = clc.xterm(x256(...theme.textTitle.getBytes()))
  m8Text.value = clc.xterm(x256(...theme.textValue.getBytes()))
}
  ...
  projectCommand
    ...
    .action((m8FilePath, options) => {
      ...
      for (let i = startingRow; i < startingRow + 16; i++) {
        ...
        const type = midiMapping.typeToChar()
        ...
        if (midiMapping.empty) {
          ...
          // TODO: Should this be moved to an Instrument method?
          switch (type) {
            case 'M':
              instrDisplay = paramIndex
              paramDisplay = MixerSettings.getMIDIDestLabels()[paramIndex]
              break

            case 'X':
              instrDisplay = paramIndex
              paramDisplay = EffectsSettings.getMIDIDestLabels()[paramIndex]
              break

            case 'I':
              instrDisplay = instrIndex
              paramDisplay = InstrumentMIDIMappings[instrIndex]?.[paramIndex] || 'UNUSED'
...
${m8Text.default('BACKGROUND')}   ${m8Text.value(toM8HexStr(theme.background.r))} ${m8Text.value(toM8HexStr(theme.background.g))} ${m8Text.value(toM8HexStr(theme.background.b))} ${clc.xterm(x256(...theme.background.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:EMPTY')}   ${m8Text.value(toM8HexStr(theme.textEmpty.r))} ${m8Text.value(toM8HexStr(theme.textEmpty.g))} ${m8Text.value(toM8HexStr(theme.textEmpty.b))} ${clc.xterm(x256(...theme.textEmpty.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:INFO')}    ${m8Text.value(toM8HexStr(theme.textInfo.r))} ${m8Text.value(toM8HexStr(theme.textInfo.g))} ${m8Text.value(toM8HexStr(theme.textInfo.b))} ${clc.xterm(x256(...theme.textInfo.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:DEFAULT')} ${m8Text.value(toM8HexStr(theme.textDefault.r))} ${m8Text.value(toM8HexStr(theme.textDefault.g))} ${m8Text.value(toM8HexStr(theme.textDefault.b))} ${clc.xterm(x256(...theme.textDefault.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:VALUE')}   ${m8Text.value(toM8HexStr(theme.textValue.r))} ${m8Text.value(toM8HexStr(theme.textValue.g))} ${m8Text.value(toM8HexStr(theme.textValue.b))} ${clc.xterm(x256(...theme.textValue.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('TEXT:TITLES')}  ${m8Text.value(toM8HexStr(theme.textTitle.r))} ${m8Text.value(toM8HexStr(theme.textTitle.g))} ${m8Text.value(toM8HexStr(theme.textTitle.b))} ${clc.xterm(x256(...theme.textTitle.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('PLAY MARKERS')} ${m8Text.value(toM8HexStr(theme.playMarker.r))} ${m8Text.value(toM8HexStr(theme.playMarker.g))} ${m8Text.value(toM8HexStr(theme.playMarker.b))} ${clc.xterm(x256(...theme.playMarker.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('CURSOR')}       ${m8Text.value(toM8HexStr(theme.cursor.r))} ${m8Text.value(toM8HexStr(theme.cursor.g))} ${m8Text.value(toM8HexStr(theme.cursor.b))} ${clc.xterm(x256(...theme.cursor.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('SELECTION')}    ${m8Text.value(toM8HexStr(theme.selection.r))} ${m8Text.value(toM8HexStr(theme.selection.g))} ${m8Text.value(toM8HexStr(theme.selection.b))} ${clc.xterm(x256(...theme.selection.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('SCOPE/SLIDER')} ${m8Text.value(toM8HexStr(theme.scopeSlider.r))} ${m8Text.value(toM8HexStr(theme.scopeSlider.g))} ${m8Text.value(toM8HexStr(theme.scopeSlider.b))} ${clc.xterm(x256(...theme.scopeSlider.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('METER LOW')}    ${m8Text.value(toM8HexStr(theme.meterLow.r))} ${m8Text.value(toM8HexStr(theme.meterLow.g))} ${m8Text.value(toM8HexStr(theme.meterLow.b))} ${clc.xterm(x256(...theme.meterLow.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('METER MID')}    ${m8Text.value(toM8HexStr(theme.meterMid.r))} ${m8Text.value(toM8HexStr(theme.meterMid.g))} ${m8Text.value(toM8HexStr(theme.meterMid.b))} ${clc.xterm(x256(...theme.meterMid.getBytes()))('\u25A0\u25A0\u25A0')}
${m8Text.default('METER PEAK')}   ${m8Text.value(toM8HexStr(theme.meterPeak.r))} ${m8Text.value(toM8HexStr(theme.meterPeak.g))} ${m8Text.value(toM8HexStr(theme.meterPeak.b))} ${clc.xterm(x256(...theme.meterPeak.getBytes()))('\u25A0\u25A0\u25A0')}
`)
    })
