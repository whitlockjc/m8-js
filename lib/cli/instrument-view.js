...
const { loadM8FileAndVerify, loadTheme, printInstrument, validateInstrumentOption } = require('./helpers')

/**
 * The action for the 'instrument view' command.
 *
 * @param {String} m8FilePath - The M8 file path
 * @param {module:commander.Option} options - The CLI options
 */
const instrumentView = (m8FilePath, options) => {
